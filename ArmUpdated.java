...
public class Arm {
    ...
    //Draw Line
        ...
        try {
            ...
            //create an arraylist of coordinates (each coordinate is an array with an x and y value)
            List<double[]> coordinates = new ArrayList<>();
            coordinates.add( new double[]{330, 190});   //these are test values for a line
            coordinates.add( new double[]{330, 210});
            coordinates.add( new double[]{330, 230});
            coordinates.add( new double[]{330, 250});
            coordinates.add( new double[]{330, 270});
            coordinates.add( new double[]{330, 290});
            coordinates.add( new double[]{330, 310});
            coordinates.add( new double[]{330, 330});
    ...
    private double findRightArmAngle(double toolX, double toolY) {
        ...
        double angle = Math.atan2(jointY - motorRightY, jointX - motorRightX);
    ...
    private double findLeftArmAngle(double toolX, double toolY){
        ...
        double angle = Math.atan2(jointY - motorLeftY, jointX - motorLeftX);
        //angle = Math.PI - angle;    //want outer angle on triangle of motor position and joint position
